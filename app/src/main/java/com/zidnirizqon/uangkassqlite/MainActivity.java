package com.zidnirizqon.uangkassqlite;
...
import com.zidnirizqon.uangkassqlite.helper.SqliteHelper;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void KasAdapter()
    {
        ...
        if(i == 0)
        {
            Toast.makeText(getApplicationContext(), "Tidak ada Tranasaksi Untuk ditampilkan", Toast.LENGTH_LONG).show();
        }
    ...
    private void Hapus()
    {
        ...
        builder.setPositiveButton("iya", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(getApplicationContext(), "Transaski Berhasil Di Hapus", Toast.LENGTH_LONG).show();
                KasAdapter();
            }
        });
    ...
    protected void onResume() {
        ...
        if(filter){
            query_kas = "SELECT *, strftime('%d/%m/%Y', tanggal) AS tanggal FROM transaksi" +
